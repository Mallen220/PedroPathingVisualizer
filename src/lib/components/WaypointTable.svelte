          ...
          <tr>
            ...
            >
              <div class="flex flex-col items-center gap-6">
                <div
                  class="p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <div class="text-sm max-w-xs mx-auto">
                  <p
                    class="font-medium text-lg text-neutral-800 dark:text-neutral-200 mb-2"
                  >
                    Start your path
                  </p>
                  <p class="text-neutral-500 dark:text-neutral-400 mb-6">
                    Add a path segment to move the robot, or a wait command for
                    pauses.
                  </p>
                  ...
                  <div class="flex flex-row gap-3 justify-center">
                    <button
                      ...
                      class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-600 dark:bg-green-700 rounded-lg shadow-sm hover:bg-green-700 dark:hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:ring-offset-neutral-900"
                    ...
                    <button
                      ...
                      class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-amber-500 dark:bg-amber-600 rounded-lg shadow-sm hover:bg-amber-600 dark:hover:bg-amber-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 dark:ring-offset-neutral-900"

...
<script lang="ts">
  ...
  import { updateLinkedLines, isLinked } from "../../utils/pointLinking";
    ...
    <div class="flex flex-row items-center gap-2 flex-wrap">
      ...
      <div class="relative min-w-[100px]">
        <input
          ...
          on:input={() => {
            // Handle linking: name change may trigger snap
            lines = updateLinkedLines(lines, line.id || "", "name");
      ...
      <div class="flex flex-wrap justify-start items-center gap-x-4 gap-y-2">
        <div class="flex items-center gap-2">
          ...
          <input
            ...
            on:input={() => {
              lines = updateLinkedLines(lines, line.id || "", "xy");
            }}
            disabled={line.locked}

...
<div class="w-full flex flex-col gap-4 p-4 pb-32">
  {#if result}
    ...
    >
      <div
        class="px-4 py-3 border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/50"
      >
        <h3
      ...
      <div class="p-4 grid grid-cols-1 gap-4">
        ...
        <div class="flex items-center justify-between">
          <div class="flex flex-col">
            <span
              class="text-xs text-neutral-500 dark:text-neutral-400 font-medium uppercase tracking-wider"
              >Total Time</span
            >
          ...
          <div class="flex flex-col items-end">
            ...
            >
            <span
              class="text-sm font-bold {result.statsDiff.time.diff > 0
                ? 'text-red-500'
                : result.statsDiff.time.diff < 0
                  ? 'text-green-500'
                  : 'text-neutral-400'}"
            >
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex flex-col items-end">
            ...
            >
            <span
              class="text-sm font-bold {result.statsDiff.distance.diff > 0
    ...
    >
      ...
      <div class="p-4">
        {#if addedEvents.length === 0 && removedEvents.length === 0 && changedEvents.length === 0}
          <div
            class="flex flex-col items-center justify-center py-6 text-neutral-400 dark:text-neutral-500 gap-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        {:else}
          <div class="space-y-3">
            {#each addedEvents as item}
              <div
                class="flex items-start gap-3 p-2 rounded-md bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-900/30"
              >
                <div class="flex-none mt-0.5">
                  <div
                    class="w-5 h-5 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center text-green-600 dark:text-green-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p
                    class="text-xs text-neutral-500 dark:text-neutral-400 break-words"
                  >
                    {item.description}
                  </p>
                </div>
            ...
            {#each removedEvents as item}
              <div
                class="flex items-start gap-3 p-2 rounded-md bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30"
              >
                <div class="flex-none mt-0.5">
                  <div
                    class="w-5 h-5 rounded-full bg-red-100 dark:bg-red-800 flex items-center justify-center text-red-600 dark:text-red-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
            ...
            {#each changedEvents as item}
              <div
                class="flex items-start gap-3 p-2 rounded-md bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30"
              >
                <div class="flex-none mt-0.5">
                  <div
                    class="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-800 flex items-center justify-center text-blue-600 dark:text-blue-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"

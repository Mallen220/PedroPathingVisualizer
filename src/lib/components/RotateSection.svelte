...
<div
  ...
  class={`flex flex-col w-full justify-start items-start gap-1 ${isSelected ? "border-l-4 border-purple-500 pl-2" : ""}`}
...
>
    ...
    <div class="flex flex-row items-center gap-2 flex-wrap">
      ...
      <div class="relative">
        <input
          ...
          class:text-purple-500={hoveredRotateId === rotate.id}
        ...
        {#if linked}
          ...
          <div
            class="absolute right-1 top-1/2 -translate-y-1/2 text-purple-500 cursor-help flex items-center justify-center"
          ...
          >
            ...
            {#if hoveredRotateId === rotate.id}
              <div
                ...
                class="w-64 p-2 bg-purple-100 dark:bg-purple-900 border border-purple-300 dark:border-purple-700 rounded shadow-lg text-xs text-purple-900 dark:text-purple-100 z-50 pointer-events-none"
              >
  ...
  {#if !collapsed}
    <div class={`h-[0.75px] w-full bg-purple-400/50 my-1`} />
